...
class EvalInfo(BaseModel):
    ...
    aa_intelligence_index: Optional[float] = None
    aa_coding_index: Optional[float] = None
    aa_math_index: Optional[float] = None
    ...
    lmarena_coding: Optional[float] = None
    lmarena_math: Optional[float] = None
    lmarena_hard: Optional[float] = None
